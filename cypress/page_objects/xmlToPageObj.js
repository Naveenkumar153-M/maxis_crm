...
console.log('==========================================================================\n');
fs.removeSync(__dirname + '/crm.po.json');

function generatePageObject() {
	fs.readFile(__dirname + '/crm.po.xml', function (err, data) {
		parser.parseString(data, function (err, result) {
			...
			fs.writeFile(__dirname + '/crm.po.json', JSON.stringify(pobj, null, 2), function () {
